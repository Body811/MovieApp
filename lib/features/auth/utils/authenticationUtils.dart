...
class AuthenticationAppbar{
    static AppBar getAppbar({required BuildContext context, required Color backgroundColor}){
      return AppBar(
...
class OtpFieldState extends State<OtpField> {
  ...
  void _updateBorderColor(int index) {
    setState(() {
      borderColors[index] = controllers[index].text.isNotEmpty ? Colors.green : Colors.grey;
    });
  }
  @override
  Widget build(BuildContext context) {
